...
namespace TA.SnapCap.DeviceInterface
    ...
    public class SnapCapFlatPanel : ISnapCapSwitch
        ...
        public SnapCapFlatPanel([NotNull] string name, [NotNull] string description,
            [NotNull] DeviceController controller)
            {
        ...
        /// <summary>Gets the ELP brightness in the range 0 to 100%</summary>
        /// <returns></returns>
        /// <remarks>
        ///     SnapCap accepts brightness values in the range 25..255. We assume that 24 or less is the same
        ///     as 'off' or 0% illumination. Therefore a value of 25 should not cause a return value of 0%.
        /// </remarks>
        ...
        /// <summary>
        ///     Turns on the electroluminescent panel on or off. When turning on, the brightness setting is
        ///     also set to a nonzero value. If known, the last set brightness will be used, otherwise 50% is
        ///     assumed.
        /// </summary>
